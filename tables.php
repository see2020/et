<?php
	...
	if($TblSetting["table"]["name"] == ""){
		...
		echo Message("Ќе задана стартова€ таблица<br><a href='./quit.php'>¬ыход</a> | <a href='./tables.php'>Ќа главную</a>", "error");
		exit;
	}
	...
	/* $u_access = true;
	// доступность провер€ем только по доступу к таблице
	// если у пользовател€ к данной таблице есть определнный доступ "new", "read", "edit", ...
